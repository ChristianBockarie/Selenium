...
public class JSDemo extends CommonMethods {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String url = "https://www.tools.com/automation-practice-form/";
		setUpDriver("chrome", url);
		//Scroll down to the page
		
		JavascriptExecutor js = (JavascriptExecutor)driver;
		js.executeScript("window.scrollBy(0,550)");//scroll down we use positive value
		js.executeScript("window.scrollBy(0,-303");//scroll up we use negative value
//		Thread.sleep(2000);
